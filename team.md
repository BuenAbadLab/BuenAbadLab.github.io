...
<div class="profile">
  ...
  <div class="profile__info">
    ...
    <p>
      ...
      Computational Biology at UC Berkeley, advised by Drs. Liana Lareau and
      Nir Yosef, and his Bachelor's degree in Biology at the National
      Autonomous University of Mexico.
    </p>
    <p class="profile__links">
      <a href="{{ "/pdfs/torino-preprint.pdf" | relative_url }}">Preprint</a> &middot;
      <a href="{{ site.scholar_url }}">Google Scholar</a> &middot;
